...
To run this Python script, you only need:

* **Python 3** (version 3.6 or higher) installed on your system.
...
Once the script starts, the program will prompt you to enter various words one by one.

1.  Read the prompt (e.g., `Adjective: `).
2.  Type a word of that type (e.g., `sparkling`).
3.  Press **Enter**.
...
* **Millani Khabir** - Initial work - **[millani05]** inspired by freecodecamp.org
    * linkedin
